	...
	stepState.numericColumns.forEach( function( col, index ) {
		...
		$dataList.append(
			'<label class="dwm-wizard-col-item" for="' + id + '">' +
				'<input type="radio" id="' + id + '" name="dwm_wizard_doughnut_data_column" value="' + escapeHtml( normalized ) + '"' + checked + '>' +
