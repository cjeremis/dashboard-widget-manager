...
export function renderStep( $container ) {
	...
	$container.html(
		'<div class="dwm-form-group">' +
			'<select id="dwm-wizard-card-list-table-select" class="dwm-select dwm-wizard-table-select middle-aligned">' +
				'<option value="">Loading tables\u2026</option>' +
			'</select>' +
		'</div>' +
		'<div id="dwm-wizard-card-list-columns-grid" class="dwm-wizard-columns-grid" style="display:none">' +
			'<div class="dwm-wizard-columns-header">' +
				...
				'<div class="dwm-wizard-columns-actions">' +
					'<a href="#" class="dwm-wizard-card-list-select-all">Select All</a>' +
					'<span class="dwm-wizard-columns-separator">|</span>' +
					'<a href="#" class="dwm-wizard-card-list-deselect-all">Deselect All</a>' +
				'</div>' +
			'</div>' +
			'<div id="dwm-wizard-card-list-columns-list" class="dwm-wizard-columns-list"></div>' +
		'</div>'
	);
	...
	cols.forEach( function( col ) {
		...
		html +=
			'<label class="dwm-wizard-col-item">' +
				'<input type="checkbox" class="dwm-wizard-card-list-col-checkbox" value="' + col.name + '"' + checked + '>' +
