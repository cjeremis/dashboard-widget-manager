...
export function renderStep( $container ) {
	...
	$container.html(
		'<div class="dwm-form-group">' +
			'<select id="dwm-wizard-pie-table-select" class="dwm-select dwm-wizard-table-select middle-aligned">' +
				'<option value="">Loading tables…</option>' +
			'</select>' +
		'</div>' +
		'<div id="dwm-wizard-pie-columns-grid" class="dwm-wizard-columns-grid" style="display:none">' +
			'<div class="dwm-wizard-columns-header">' +
				...
				'<div class="dwm-wizard-columns-actions">' +
					'<a href="#" class="dwm-wizard-pie-select-all">Select All</a>' +
					'<span class="dwm-wizard-columns-separator">|</span>' +
					'<a href="#" class="dwm-wizard-pie-deselect-all">Deselect All</a>' +
				'</div>' +
			'</div>' +
			'<div id="dwm-wizard-pie-columns-list" class="dwm-wizard-columns-list"></div>' +
		'</div>'
	);
	...
	columns.forEach( function( col ) {
		...
		$list.append(
			'<label class="dwm-wizard-col-item" for="' + checkboxId + '">' +
				'<input type="checkbox" id="' + checkboxId + '" class="dwm-wizard-pie-col-checkbox" value="' + colName + '"' + ( isChecked ? ' checked' : '' ) + '>' +
