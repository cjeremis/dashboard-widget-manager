...
<div class="dwm-demo-import-intro">
	<p><?php esc_html_e( 'Import sample widgets to explore what Dashboard Widget Manager can do. Demo widgets are clearly marked and can be removed at any time.', 'dashboard-widget-manager' ); ?></p>
</div>
...
<div class="dwm-export-toggle-group">
	<div class="dwm-export-toggle-row">
		...
		<div class="dwm-export-toggle-content">
			...
			<span class="dwm-export-toggle-desc"><?php esc_html_e( 'Import 6 sample dashboard widgets with real WordPress data queries', 'dashboard-widget-manager' ); ?></span>
		</div>
	</div>
</div>
